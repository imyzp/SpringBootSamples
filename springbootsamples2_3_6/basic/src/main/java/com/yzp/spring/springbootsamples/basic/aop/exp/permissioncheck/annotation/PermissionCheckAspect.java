package com.yzp.spring.springbootsamples.basic.aop.exp.permissioncheck.annotation;

import com.yzp.spring.springbootsamples.basic.aop.exp.permissioncheck.enums.UserRoleEnum;
import com.yzp.spring.springbootsamples.basic.exception.CustomException;
...
public class PermissionCheckAspect {
    @Pointcut(value = "@within(com.yzp.spring.springbootsamples.basic.aop.exp.permissioncheck.annotation.PermissionCheck) || @annotation(com.yzp.spring.springbootsamples.basic.aop.exp.permissioncheck.annotation.PermissionCheck)")
