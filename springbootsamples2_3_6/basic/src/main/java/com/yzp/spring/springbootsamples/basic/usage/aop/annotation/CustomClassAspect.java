package com.yzp.spring.springbootsamples.basic.usage.aop.annotation;
...
public class CustomClassAspect {
     ...
     */
    @Pointcut(value = "@within(com.yzp.spring.springbootsamples.basic.usage.aop.annotation.CustomClassAnnotation) && " +
            "!execution(* com.yzp.spring.springbootsamples.basic.usage.aop.api.AopClassController.exclude())")
